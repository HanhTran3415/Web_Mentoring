  ...
  <div class="container">
    ...
    <form @submit.prevent="handleSubmit" autocomplete="on">
      ...
      <div class="box">
        ...
        <div class="inputBox">
          <input type="text" id="firstName" v-model="form.firstName" @blur="validateField('firstName')" placeholder="Họ"
            required />
      ...
      <div class="box">
        ...
        <div class="iconBox"><i class="fa fa-user" aria-hidden="true"></i></div>
        <div class="inputBox">
          <input type="text" id="lastName" v-model="form.lastName" @blur="validateField('lastName')" placeholder="Tên"
            required />
      ...
      <div class="box">
        ...
        <div class="inputBox">
          <input type="password" id="confirmPassword" v-model="form.confirmPassword"
            @blur="validateField('confirmPassword')" placeholder="Xác minh mật khẩu" required />
      ...
      <div class="box">
        ...
        <div class="inputBox">
          <input type="email" id="email" v-model="form.email" @blur="validateField('email')" placeholder="Email"
            required />
      ...
      <div class="box">
        ...
        <div class="inputBox">
          <input type="text" id="phoneNo" v-model="form.contactNo" @blur="validateField('contactNo')"
